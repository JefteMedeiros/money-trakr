...
>(
  (
    { side = "right", variant = "glass", className, children, ...props },
    ref,
  ) => {
    const getVariantClass = () => {
      ...
      const variants = {
        glass:
          "glass-bg backdrop-blur-[var(--blur-lg)] border border-[var(--glass-border)] text-foreground shadow-[var(--glass-shadow-lg)]",
        glassSubtle:
        ...
        fluted:
          "glass-fluted backdrop-blur-[var(--blur)] border border-[var(--glass-border)] text-foreground shadow-[var(--glass-shadow-lg)]",
        crystal:
